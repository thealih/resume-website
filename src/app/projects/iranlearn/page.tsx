...
const IranLearn: FC = () => {
  return (
    <>
      ...
      <div className="p-10 mx-10 text-gray-600">
        <div className="lg:flex justify-between lg:flex-row-reverse gap-x-10 ">
          ...
          <ul className="mx-5 space-y-6 lg:w-1/2">
            <li>
            ...
            <li>
              <span className="font-mono mr-3 text-black"> عنوان پروژه : </span>
              وبسایت خرید دوره های آموزشی
            </li>
            <li>
              <span className="font-mono mr-3 text-black">آدرس وبسایت : </span>
              <Link
            ...
            <li className="text-justify">
              <span className="font-mono mr-3 text-black">توضیحات : </span>
              این پروژه یک فروشگاه آنلاین برای خرید محصولات دیجیتال است. هدف از
              این وبسایت، ایجاد تجربه کاربری ساده و راحت برای مشتریان است تا
              بتوانند به آسانی محصولات مورد نیاز خود را جستجو و خریداری کنند.
              نقش من در این پروژه توسعه کامل بخش فرانت‌اند با استفاده از React و
              طراحی رابط کاربری بود.
            </li>
            <li>
              {" "}
